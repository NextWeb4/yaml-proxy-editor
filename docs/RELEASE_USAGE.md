...
| --- | --- |
| `YAML-Proxy-Editor-0.2.0-x64-setup.exe` | Standard Windows installation with the NSIS installer flow. |
| `YAML-Proxy-Editor-0.2.0-x64-zh-CN.msi` | Windows Installer based deployment, especially when MSI tooling is preferred. |

| 文件 | 建议用途 |
| --- | --- |
| `YAML-Proxy-Editor-0.2.0-x64-setup.exe` | 常规 Windows 安装，使用 NSIS 安装流程。 |
| `YAML-Proxy-Editor-0.2.0-x64-zh-CN.msi` | 需要 Windows Installer / MSI 部署流程时使用。 |
